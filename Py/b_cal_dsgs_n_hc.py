...
def testing_area() :
    ...
    ##
    fp = '/var/genetics/ws/mahdimir/LOCAL/prj/imputed-genotype-corr-240317/med/flt_snps/c1.txt'

    df1 = pd.read_csv(fp , sep = '\t')

    ##
    fp = '/var/genetics/ws/mahdimir/LOCAL/prj/imputed-genotype-corr-240317/med/fs_po_ids.txt'
